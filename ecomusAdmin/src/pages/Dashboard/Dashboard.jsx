        ...
        >
          <div className="row">
            <div className="col-lg-4 mb-2 col-md-6 col-12 dbox">
              <div className="row bg-white  d-flex align-items-center rounded py-2">
                ...
                <div className="col-9">
                  <p className="dbold">{data?.userCount
                  }</p>
            ...
            <div className="col-lg-4 mb-2 col-md-6 col-12 dbox">
              <div className="row bg-white py-3 d-flex align-items-center rounded py-2">
                ...
                <div className="col-9">
                  <p className="dbold">{data?.catCount}</p>
            ...
            <div className="col-lg-4  mb-2 col-md-6 col-12 dbox">
              <div className="row bg-white py-3 d-flex align-items-center rounded py-2">
                ...
                <div className="col-9">
                  <p className="dbold">{data?.totalOrder}</p>
          ...
          <div className="row mt-3 mx-1">
            <div className="col-lg-6 col-12 dbox rounded my-lg-0 my-2 bg-white specailshow">
              ...
              {data?.latestCustomer.map((item, index) => (
            ...
            <div className="col-lg-6 col-12 dbox">
              <div className="row rounded bg-white ">
                ...
                {data?.orderLatest?.map((item, index) => (
                  <div className="headtb">
