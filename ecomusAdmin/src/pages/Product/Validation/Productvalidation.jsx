...
export const Productvalidation = Yup.object({
  ...
  mrp_price: Yup.number().label("MRP Price").required("Please Enter MRP Price"),
  stock: Yup.number().label("Stock").min(2).required("Please Enter Stock"),
  weight: Yup.number()
    .label("Weight")
    .nullable() // Allows the field to be blank
    .notRequired(),
  ...
  child_category: Yup.array().label("child Category"),
  // attribute: Yup.array()
  // .label("Attribute"),
  status: Yup.string()
