          ...
          <div className="col-lg-12 col-sm-12  mt-lg-2 mt-1 mb-2">
            ...
            <div className="container-fluid">
              <div className="row Thankpage">
               ...
               <div className="Imgverify"> <img src="./images/icon/Group1.png" alt="img-fluid" style={{width:'23%',margin:'auto'}} className="boyimg"/></div>
                    <h2 className="Fontthank" style={{fontWeight:'600'}}> <a href="Thank you" style={{color:'#059fe2'}}>Thank you</a> for your order <img src="./images/icon/Group2.png" alt="404" className="Checkimg2 m-auto my-2"/></h2>
                </div>
                <div>
